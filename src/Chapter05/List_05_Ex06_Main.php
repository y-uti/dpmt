...
class List_05_Ex06_Main
{
    public static function main(array $argv)
    {
        ...
        $threads = [];
        $threads[] = new List_05_Ex06_MakerThread('MakerThread-1', $table, $counter);
        $threads[] = new List_05_Ex06_MakerThread('MakerThread-2', $table, $counter);
        $threads[] = new List_05_Ex06_MakerThread('MakerThread-3', $table, $counter);
